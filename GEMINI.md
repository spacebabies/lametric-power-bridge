...
```
┌─────────────────────────────────────────────────────────────┐
│                    lametric_power_bridge/main.py (43 lines)                     │
│                     Orchestrator                            │
│                                                             │
...
│   └── test_lametric_power_bridge/main.py          # Bridge logic tests (5 tests)
```
...
python lametric_power_bridge/main.py
python lametric_power_bridge/main.py --source=tibber

# HomeWizard v1 API (HTTP Polling)
python lametric_power_bridge/main.py --source=homewizard-v1

# HomeWizard v2 API (WebSocket)
python lametric_power_bridge/main.py --source=homewizard-v2

# P1 Serial (DSMR via USB)
python lametric_power_bridge/main.py --source=p1-serial
```
...
The current `get_source()` function in `lametric_power_bridge/main.py`:
...
4. **Update `get_source()` in lametric_power_bridge/main.py** (add elif case + argparse choices)
...
```ini
[Service]
ExecStart=/path/to/.venv/bin/python /path/to/lametric_power_bridge/main.py
...
**Loading in lametric_power_bridge/main.py**:
```python
...
- Separation of egress logic from lametric_power_bridge/main.py
- Created `sinks/lametric.py`
- lametric_power_bridge/main.py: 201 → 146 lines (-55)
...
- lametric_power_bridge/main.py: 199 → 43 lines (-78%!)
...
- Command: `python lametric_power_bridge/main.py --list-sources` to show available sources
